...
public interface Constants
{
	...
	String AZURE_OUTPUT_ACCOUNT_KEY = "vbSDcGSy2mbW55B2xMpkJ5Ns93CxNYJUIOz0kEdtQzhzv1+Wh87o5Daf9cf9zt6v1h2nLdiR/bzQqGvEPWFAGA==";
	...
	String STATUS_POLL_RETRY_FAILED = "POLL_RETRY_ERROR";
	String STATUS_JOB_RETRY = "RETRY_JOB";
	String STATUS_POLL_RETRY = "RETRY_POLL";
	String STATUS_RETRY_SUBMITTED = "RETRY_SUBMITTED";
	String STATUS_RETRY_FAILED = "RETRY_FAILED";
	Integer STATUS_CODE_SERVER_ERROR = 500; // 500 : Internal Server Error,502 : Bad Gateway,503 : Service Unavailable,520 : Unknown Error
	Integer STATUS_CODE_BAD_REQUEST = 400; // 400 : Bad Request,401 : Unauthorized,403 : Forbidden,404 : Not Found,408 : Request Timeout,419 : Authentication Timeout,429 : Too Many Requests  
	...
	String CASTLABS_KEY_INGEST_URL = "https://fe.staging.drmtoday.com/frontend/api/keys/v2/ingest/" + CASTLABS_MERCHANT_NAME;
	String CASTLABS_AUTH_PAYLOAD = "username=" + CASTLABS_MERCHANT_NAME + "::" + CASTLABS_MERCHANT_USER_ID + "&password=" + CASTLABS_MERCHANT_PASSWORD;

	/* Error */
	String ERROR_JSON_PARSING = "Could not extract bitcodin job from job string";
	String ERROR_DRM_CONFIG = "An error occured while fetching DRM configuration";
	String ERROR_JOB_CREATION = "Job creation failed";
	String ERROR_GETTING_JOB_ID = "An error occured while fetching jobId from the response";
	String ERROR_JOB_SUMMARY = "An error occured while creating the encode job summary";
	String ERROR_POLLING_FAILED = "Polling failed for the job id";
	String ERROR_JOB_STATUS_UNKNOWN = "Polling job with unknown status";
