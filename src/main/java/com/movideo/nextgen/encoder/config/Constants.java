...
/**
 * Contains all the constants. Right now, this class is a dump containing every
 * configuration ever needed. Needs to be cleaned up and portion of this
 * information needs to come from dropbox and some others from the application
 * init
 * 
